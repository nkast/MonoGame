...
namespace MonoGame.Tools.Pipeline
{
    public partial class PipelineController : IController
    {
        ...
        {
// restore .net Framework paths - end
            "/Library/Frameworks/MonoGame.framework/Current/Tools",
// restore .net Framework paths - end
#if DEBUG
// restore .net Framework paths - start
            "../../../../../MonoGame.Content.Builder/bin/Windows/AnyCPU/Debug",
...
#else
// restore .net Framework paths - start
            "../../../../../MonoGame.Content.Builder/bin/Windows/AnyCPU/Release",
...
#endif
// restore .net Framework paths - start
            Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), "../MonoGame.Content.Builder"),
