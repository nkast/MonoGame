...
namespace Microsoft.Xna.Framework
{
    public class GenericSwapChainPanel
    {
        ...
        internal GenericSwapChainPanel(SwapChainBackgroundPanel swapChainPanel)
        {
            Panel = swapChainPanel;
        }
        ...
        public static implicit operator UIElement(GenericSwapChainPanel genericSwapChainPanel)
        {            
            return genericSwapChainPanel.Panel;
        }
    }
}
